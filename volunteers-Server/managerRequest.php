            ...
            <div class="inner">
                ...
                <div class="col-lg-12">
                    ...
                    <?php if(isset($_GET['success'])){ ?>
                              ...
                              <?php } ?>
                              <a href="manager_request_report.php" class="btn btn-primary waves-effect waves-light"><i class=""></i> Print</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    while($rowRequest = $queryRequest->fetch_assoc())
                                    {
                                        ...
                                        <td>
                                        <?php if($rowRequest['status'] == "Waiting") { ?>
                                                    <a href="managerRequest.php?status2=<?php echo $rowRequest['requestId'] ?>" class="badge badge-danger">Click to accept</a>
                                            <?php } ?>
                                                <br/>
                                            <?php if($rowRequest['status'] == "Waiting") { ?>
                                                <br/>
                                                <a href="managerRequest.php?status=<?php echo $rowRequest['requestId'] ?>" class="badge badge-barger" style="background-color: green">click to Dinie</a>
                                            <?php } ?>
